...
?>
<section class="home-section home-campaigns" aria-labelledby="campaigns-title" data-carousel>
	<div class="container container--wide section-frame">
		<header class="section-frame__header"><h2 id="campaigns-title">Campañas</h2></header>
		...
		<div class="carousel carousel--campaigns<?php echo $campaigns->post_count <= 2 ? ' carousel--sparse' : ''; ?>" id="campaigns-carousel" data-carousel-track tabindex="0" role="group" aria-roledescription="<?php esc_attr_e( 'carrusel', 'ddna-theme' ); ?>" aria-label="<?php esc_attr_e( 'Campañas destacadas', 'ddna-theme' ); ?>">
			<?php while ( $campaigns->have_posts() ) : $campaigns->the_post(); get_template_part( 'template-parts/components/campaign-card' ); endwhile; ?>
		</div>
	</div>
</section>
